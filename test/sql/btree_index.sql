...
create table btree_bpchar (f1 text collate "C") using gamma;
...
--
CREATE TABLE dedup_unique_test_table (a int) using gamma WITH (autovacuum_enabled=false);
...
-- with a short tree.
create table btree_tall_tbl(id int4, t text) using gamma;
...
--
CREATE TABLE delete_test_table (a bigint, b bigint, c bigint, d bigint) using gamma;
